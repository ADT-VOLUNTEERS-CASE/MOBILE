...
Основная цель этого проекта - сократить количество бумажной работы координаторов мероприятий, поскольку она сильно замедляет и усложняет и без того непростой цикл проведения.
...
> 
> **P.S. Доступ к админке есть у кого угодно, поэтому как данные пользователя, так и мероприятия с локациями/тегами могут видоизменяться, а БД периодически сбрасываться.**
>
...
> [!NOTE]  
> Если вы нашли баг в демо-версии или у вас не запускается приложение, [создайте Issue](../../issues/new/choose), прикрепив модель устройства и установленную OC.

1. Перейдите на страницу [Releases](../../releases/latest)
2. Нажмите на последнюю версию с тегом ```Latest``` или ```Pre-release```
